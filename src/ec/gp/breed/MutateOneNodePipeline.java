...
public class MutateOneNodePipeline extends GPBreedingPipeline
    ...
    public int produce(final int min, 
        ...
        for(int q=start; q < n+start; q++)
            ...
            p1 = nodeselect.pickNode(state,subpopulation,thread,i,i.getTree(t));//========zhixing, 2021.3.26
            ...
            p2 = (GPNode)(pickCompatibleNode(p1,i.getTree(t).constraints(initializer).functionset,state,type,thread)).lightClone();//========zhixing, 2021.3.26
            ...
            if (sources[0] instanceof BreedingPipeline)
                ...
                for(int x=0;x<j.getTreesLength();x++)
                    ...
                    if (x==t)  // we've got a tree with a kicking cross position!
                        ...
                        tree.owner = j;
                        tree.child = i.getTree(x).child.cloneReplacingAtomic(p2,p1);
