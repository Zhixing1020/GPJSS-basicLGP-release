    ...
    public int produce(final int min, final int max, final int start,
        ...
        for (int q = start; q < n + start; /* no increment */) // keep on going until we're filled up
            ...
            if (tree1 == TREE_UNFIXED || tree2 == TREE_UNFIXED) 
                ...
                if (parents[0].getTree(t1).constraints(initializer) != parents[1].getTree(t2).constraints(initializer)) // uh oh //========zhixing, 2021.3.26
            ...
            boolean res1 = false;
            boolean res2 = false;
            GPTree tree2 = parents[1].getTree(t2);
            ...
            for (int x = 0; x < numTries; x++) 
                ...
                p1 = nodeselect1.pickNode(state, subpopulation, thread, parents[0], parents[0].getTree(t1));
