...
public class GPIndividual extends Individual
    ...
    //==============zhixing, LGP in JSS, 2021.3.26   for better protection
    protected GPTree[] trees;
    //===============
  ...
  //===============zhixing, LGP in JSS, 2021.3.26
    public void setup_extensive(final EvolutionState state, final Parameter base){
    	super.setup(state,base);  // actually unnecessary (Individual.setup() is empty)
        ...
        //how to load individual, what parameters will be read, should be all defined by subclasses
    }
    
    public Object clone_extensive()
    {
	    // a deep clone    
	    GPIndividual myobj = (GPIndividual)(super.clone());
	    return myobj;
    ...
    public GPIndividual lightClone_extensive()
    {
	    // a light clone
	    GPIndividual myobj = (GPIndividual)(super.clone());
	    return myobj;
    ...
    public boolean setTree(int index, GPTree tree){
    	if(index<trees.length){
    		...
    		System.out.println("setTree index: " + index + " is out of range " + trees.length);
    		return false;
    	}
    }
    public void renewTrees(){
    	//renew as a null GPTree []
    	trees = new GPTree[trees.length];
    }
