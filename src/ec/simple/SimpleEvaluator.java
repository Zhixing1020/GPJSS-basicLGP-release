    ...
    protected void evalPopChunk(EvolutionState state, int[] numinds, int[] from,
        ...
        for(int pop=0;pop<len;pop++)
            ...
            for (int x=fp;x<upperbound;x++){
            	...
            	//sum += ((LGPIndividual)inds[x]).getEffTreesLength();
            }
            //System.out.println("average size: "+ sum / (upperbound - fp));
            }
           
//        long finish = yimei.util.Timer.getCpuTime();
//        double duration = (finish - start) / 1000000;
//        System.out.print("INDIVIDUAL simulation time: " + duration + " mseconds\n");
