...
public class Lid extends GPProblem implements SimpleProblemForm
    ...
    public void evaluate(final EvolutionState state,
        ...
        if (!ind.evaluated)  // don't bother reevaluating
            ...
            actualDepth = ((GPIndividual) ind).getTree(0).child.depth() - 1;//=========zhixing, 2021.3.26

            actualTerminals = ((GPIndividual) ind).getTree(0).child.numNodes(GPNode.NODESEARCH_TERMINALS);//=========zhixing, 2021.3.26
    ...
    public void describe(
        ...
        actualDepth = ((GPIndividual) ind).getTree(0).child.depth() - 1; //=========zhixing, 2021.3.26
        actualTerminals = ((GPIndividual) ind).getTree(0).child.numNodes(GPNode.NODESEARCH_TERMINALS);
        state.output.println("\n\nBest Individual: in ECJ terms depth = " + (actualDepth + 1) + "; in Lid terms depth = " + actualDepth + "; number of terminal = " + actualTerminals, log);  //=========zhixing, 2021.3.26
        }
    }
