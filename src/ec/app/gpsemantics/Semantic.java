...
public class Semantic extends GPProblem implements SimpleProblemForm
    ...
    public void evaluate(final EvolutionState state,
        ...
        if (!ind.evaluated)  // don't bother reevaluating
            ...
            ArrayList output = getSemanticOutput(((GPIndividual) ind).getTree(0));  //=========zhixing, 2021.3.26
    ...
    public void describe(
        ...
        final int log)
        {
        state.output.println("\n\nBest Individual: output = " + phenotypeToString(getSemanticOutput(((GPIndividual) ind).getTree(0))), log); //=========zhixing, 2021.3.26
        }
    }
