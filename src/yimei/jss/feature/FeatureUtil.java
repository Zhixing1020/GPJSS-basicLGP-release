...
public class FeatureUtil {
    ...
    public static List<GPIndividual> selectDiverseIndis(EvolutionState state, Individual[] archive,
        ...
        pc.setReferenceRule(new GPRule(((GPIndividual)archive[0]).getTree(0)));//========zhixing, 2021.3.26
        ...
        for (Individual indi : archive) {
            ...
            int[] charList = pc.characterise(new GPRule(gpIndi.getTree(0)));//========zhixing, 2021.3.26
    ...
    public static double contribution(EvolutionState state,
        ...
        GPRule rule = new GPRule((GPTree)indi.getTree(0).clone());//========zhixing, 2021.3.26
    ...
    public static List<GPNode> buildingBlocks(List<GPIndividual> indis, int depth) {
        ...
        for (GPIndividual indi : indis) {
            collectBuildingBlocks(bbs, indi.getTree(0).child, depth);//========zhixing, 2021.3.26
        }
...
//			System.out.println("Indi " + i + ", fitness = " + newPop[i].fitness.fitness());
            adaptTree(((GPIndividual)newPop[i]).getTree(0).child, terminals);//========zhixing, 2021.3.26
